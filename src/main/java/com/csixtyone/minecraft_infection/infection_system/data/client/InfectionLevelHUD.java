...
public class InfectionLevelHUD {
    ...
    public static final IIngameOverlay INFECTION_LEVEL_HUD = (gui, poseStack, partialTicks, width, height) ->{
        ...
        float infectionLevel = (ClientInfectionLevelData.getInfectionLevel()/(float)PlayerInfectionLevel.MAX_INFECTION_LEVEL)*100;
        int infectionLevelPercent = (int)(182*(infectionLevel/100f));
